/*
 * @description: Website Optimization Project - Udacity FEND
 * #perfmatters
 * Creator:
 * Cameron Pittman, Udacity Course Developer
 * cameron *at* udacity *dot* com
 * Modified By: Sanjay Rajashekhar
 */
'use strict';
...
/*
 * @description Name generator pulled from http://saturdaykid.com/usernames/generator.html. Capitalizes first letter of each word
 */
 ...
 * @param {string} x - One of the words picked at random from the adjectives array
 */
function getAdj(x) {
    switch (x) {
        case "dark":
 ...
 * @param {string} y - One of the words picked at random from the nouns array
 */
function getNoun(y) {
    switch (y) {
        case "animals":
 ...
 * @param {number} size - Size of the pizza which can be 1(small), 2(medium) or 3(large)
 */
var resizePizzas = function (size) {
    ...
    // Changed the newWidth to percentage to avoid calculating the size of the pizza
    function changePizzaSizes(size) {
        var containerElements = document.getElementsByClassName("randomPizzaContainer");
        var newWidth = 0;
...
function updatePositions() {
    ...
    // Query the DOM once instead of querying for each iteration
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    for (var i = 0, count = cols * rows; i < count; i++) {
